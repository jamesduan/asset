...
# -----------------------------------------------------------------------------
JAVA_OPTS='-server -Xms4g -Xmx4g -XX:+UseConcMarkSweepGC -XX:+CMSIncrementalMode -XX:NewSize=512m -XX:MaxPermSize=256m -Dglobal.config.path=/var/www/webapps/config/ -Dorg.apache.catalina.startup.EXIT_ON_INIT_FAILURE=true' 
CATALINA_PID='/tmp/tomcat6.pid'
